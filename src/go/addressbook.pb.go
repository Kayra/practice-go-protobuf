...
type Person_PhoneNumber struct {
	...
	Type          Person_PhoneType       `protobuf:"varint,2,opt,name=type,proto3,enum=practice.Person_PhoneType" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_addressbook_proto_rawDesc = string([]byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x08, 0x70, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63, 0x65, 0x1a, 0x1f, 0x67,
	...
	0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x70, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63, 0x65, 0x2e, 0x50,
	...
	0x70, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63, 0x65, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x2e,
	...
	0x6c, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70, 0x72, 0x61, 0x63, 0x74,
	0x69, 0x63, 0x65, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x52, 0x06, 0x70, 0x65, 0x6f, 0x70,
	0x6c, 0x65, 0x42, 0x43, 0x5a, 0x41, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x6b, 0x61, 0x79, 0x72, 0x61, 0x2f, 0x70, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63, 0x65, 0x2d,
	0x67, 0x6f, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x73, 0x72, 0x63, 0x2f,
	0x67, 0x6f, 0x2f, 0x70, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63, 0x65, 0x2d, 0x67, 0x6f, 0x2d, 0x70,
...
var file_addressbook_proto_goTypes = []any{
	(Person_PhoneType)(0),         // 0: practice.Person.PhoneType
	(*Person)(nil),                // 1: practice.Person
	(*AddressBook)(nil),           // 2: practice.AddressBook
	(*Person_PhoneNumber)(nil),    // 3: practice.Person.PhoneNumber
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_addressbook_proto_depIdxs = []int32{
	3, // 0: practice.Person.phones:type_name -> practice.Person.PhoneNumber
	4, // 1: practice.Person.last_updated:type_name -> google.protobuf.Timestamp
	1, // 2: practice.AddressBook.people:type_name -> practice.Person
	0, // 3: practice.Person.PhoneNumber.type:type_name -> practice.Person.PhoneType
